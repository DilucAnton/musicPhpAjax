<?php
function generateArtistPage($artistId) {
    $mysqli = new mysqli("localhost", "root", "Qq123456", "music");

    $getArtistStmt = $mysqli->prepare("
    SELECT
        pseudonym,
        real_name,
        age,
...
$getArtistStmt->close();
    ...
    <body>
        ...
        <ul>
            ...
            \$result = \$mysqli->query(\"SELECT * FROM artists WHERE pseudonym = '$pseudonym'\");
        ...
        <section>
            ...
            \$defaultAboutText = \"\"; 
               \$resultAbout = \$mysqli->query(\"SELECT about FROM artists WHERE pseudonym ='$pseudonym'\");
    ...
    $filename = "artists/$pseudonym.php";
