<?php include '../auth.php'; ?>
    ...
    <head>
        ...
        <title>Britney Manson</title>
    </head>
    <body>
        <header>
            <h1>Britney Manson</h1>
            <nav>
                <ul>
        ...
        <ul>
            ...
            $result = $mysqli->query("SELECT * FROM artists WHERE pseudonym = 'Britney Manson'");
        ...
        <section>
            ...
            $defaultAboutText = ""; 
               $resultAbout = $mysqli->query("SELECT about FROM artists WHERE pseudonym ='Britney Manson'");
