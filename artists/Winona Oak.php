<?php include '../auth.php'; ?>
    ...
    <body>
        ...
        <ul>
            ...
            $result = $mysqli->query("SELECT * FROM artists WHERE pseudonym = 'Winona Oak'");
        ...
        <section>
            ...
            $defaultAboutText = ""; 
               $resultAbout = $mysqli->query("SELECT about FROM artists WHERE pseudonym ='Winona Oak'");
