...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a class="menu" href="../index.php">Главная</a></li>
            </ul>
        </nav>
    </header>
    ...
    <section>
        ...
        <ul>
            ...
            $result = $mysqli->query("SELECT * FROM artists WHERE pseudonym = 'Slayyyter'");
    ...
    <section>
        ...
        <textarea name="about_text" rows="10" cols="100"><?php 
            $defaultAboutText = ""; 
            $resultAbout = $mysqli->query("SELECT about FROM artists WHERE pseudonym ='Slayyyter'");
